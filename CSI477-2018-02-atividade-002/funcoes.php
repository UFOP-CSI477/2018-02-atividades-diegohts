...
<html lang="pt-br">
	<head>
		...
		<title>PETSHOP | A Loja para seu animal!</title>
		  ...
		  <div class="container-fluid">
		    <div class="navbar-header">
		      <a class="navbar-brand" href="index.php">
		        <img src="imagens/petshop-logo.jpg" alt="Logo Petshop" style="width:90; height:35px;"/>
		      </a>
		      ...
		      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
	        	...
	        	if(isset($_SESSION['name'])){
	        		echo '<div class="col-md-4"> 
				  	<br/>
				  	<div style="color:#FFF">Seja bem vindo, '.$_SESSION['name'].'.</div>
				  </div>';
				 } 
				?>
	            	                    ...
	            	                    <br />
	            	                      <form method="post" action="validar_acesso.php" id="formLogin">
	            	                        <div class="form-group">
	            	                            <input type="text" class="form-control" id="name" name="name" placeholder="Usuário" />
	            	                        </div>
	            	                                
	            	                        <div class="form-group">
	            	                          <input type="password" class="form-control red" id="password" name="password" placeholder="Senha" />
	            	                        </div>
	        ...
	        <div class="col-md-3"></div>
	          <div class="col-md-6">
	            ...
	            <div class="footer-copyright text-center py-3">© 2018 Copyright:
	              <a href="index.php"> PetShop.com</a>
	            </div>
	          </div>
	          <div class="col-md-3"></div>
	      </div>
...
function mostrarProduto($id, $nome, $preco, $imagem){
	echo '<div class="col-md-3">
	<form action="pagamento.php" method="get" accept-charset="utf-8">
              <div class="card" style="width: 18rem; text-align: center">
                  <img class="card-img-top" src="imagens/'.$imagem.'" alt="" style="width: 50%;">
                  <div class="card-body">
